RSpec.describe NaturalTime do
  ...
  describe ".natural_time" do
    context "seconds" do
      it "returns 0 seconds for nil" do
        expect(NaturalTime.natural_time(nil)).to eq("0 seconds")
      end
    ...
    context "years" do
      ...
      context "with precision" do
        ...
        it "ignores precision of nil" do
          expect(NaturalTime.natural_time(1.week + 1.minutes + 1.second, precision: nil)).to eq "1 week, 1 minute, 1 second"
        end
      end
    end
    ...
    describe "distance" do
      it "handles nil" do
        expect(NaturalTime.distance(nil)).to eq "0 seconds ago"
      end
  ...
  describe "to_s" do
    it "handles nil" do
      expect(NaturalTime.to_string(nil)).to eq "0 seconds"
    end
  ...
  describe "to_sentence" do
    it "handles nil" do
      expect(NaturalTime.to_sentence(nil)).to eq "0 seconds"
    end

    it "puts 'and' before the last entry in the list" do
    ...
    describe "with precision" do
      ...
      it "limits the precision to 2" do
        expect(NaturalTime.to_sentence(1.week + 1.minutes + 1.second, precision: 2)).to eq "1 week and 1 minute"
      end

      it "ignores precision of nil" do
        expect(NaturalTime.to_sentence(1.week + 1.minutes + 1.second, precision: nil)).to eq "1 week, 1 minute, and 1 second"
      end
    end
  end
  ...
  describe "to_array" do
    it "handles nil" do
      expect(NaturalTime.to_array(nil)).to eq ["0 seconds"]
    end
    ...
    describe "with precision" do
      it "limits the precision to 1" do
      ...
      it "ignores precision of nil" do
        expect(NaturalTime.to_array(1.week + 1.minutes + 1.second, precision: nil)).to eq ["1 week", "1 minute", "1 second"]
      end
    end
  end
end
